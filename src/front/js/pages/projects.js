...
function Projects() {
  return (
    <div className="pb-5">
      <div className="pt-5">
        <h2 className="pl-5 display-5 text-decoration-underline">Projects </h2>
        <br className="" />

        <div className="container-fluid d-flex">
          <div className="col-4" style={{ marginRight: "20px" }}>
            <h2 className="text-decoration-underline">JudgeFit</h2>
            <h3 className="pr-3 ">
              Using machine learning tools such as Mediapipe and OpenCV,
              JudgeFit aims to solve the issue of standardisation and
              objectivity when judging athletic performance.{" "}
            </h3>
            <br className="" />
            <h5 className="pr-3 ">Take a look at the demo here: </h5>
          </div>

          <div className="embed-responsive ratio ratio-4x3 p-l ">
            <iframe
              width="1524"
              height="585"
        ...
        <div className="container-fluid d-flex">
          ...
          <div className="col-4">
            <h2 className="text-decoration-underline">Chore Manager</h2>
            <h5 className="pr-3 ">Take a look at the demo here: </h5>
          </div>
        </div>
        <br className="" />
