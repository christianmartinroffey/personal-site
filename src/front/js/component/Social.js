...
function Social() {
  return (
    <div className="container">
      <h3>
        Social<span className="text-danger ">.</span>
      </h3>
      <ul className="icon-wrapper m-4">
        <a
          className="p-2 social-icons "
        ...
        >
          ...
          >
            <g fillRule="#151513" fillRule="evenodd">
        ...
        >
          <svg width="60" height="60" xmlns="http://www.w3.org/2000/svg">
            <g fillRule="none" fillRule="evenodd">
              <path
